class urls {
  ...
  $alfresco_ce_filename_42x = "alfresco-community-4.2.f.zip"
  $alfresco_ce_url_42x = "http://dl.alfresco.com/release/community/4.2.f-build-00012/${alfresco_ce_filename_42x}"
